...
main_loop:
    ...
    gr3 = 32; //Остаток больше 32, ограничиваем обрабатываемый размер
...
after_correct:
	...
	ar5 = ar2;
	fpu 0 rep vlen vreg0 = [ar5++]; //divisor
	ar5 = ar3;
	fpu 0 rep vlen vreg1 = [ar5++]; //~1/divisor
	ar5 = _two_dbl;
	fpu 0 rep vlen vreg2 = [ar5]; //2.0

	//Уточняем значение
	//~1/divisor = (2.0 - (~1/divisor)*divisor)*(~1/divisor);
	fpu 0 .double vreg3 = -vreg1*vreg0 + vreg2;
	fpu 0 .double vreg1 = vreg3*vreg1;
	//2
	fpu 0 .double vreg3 = -vreg1*vreg0 + vreg2;
	fpu 0 .double vreg1 = vreg3*vreg1;
	//3
	...
	ar5 = ar1;
	fpu 0 rep vlen vreg3 = [ar5++]; //divided
	fpu 0 .double vreg7 = vreg3*vreg1;
	...
	ar5 = _bigest_dbl;
	fpu 0 rep vlen vreg4 = [ar5]; //bigest double
	fpu 0 .double vreg5 = /vreg3/;
	fpu 0 .double vreg4 - vreg5, set mask if <;
    sir = fp0_dmask;
    gr3 = sir; //маска с divided = infinity

	fpu 0 .double vreg5 = /vreg0/;
	fpu 0 .double vreg4 - vreg5, set mask if <;
    sir = fp0_dmask;
    ...
    fpu 0 .double vreg3 + vreg3, set mask if =0;
    sir = fp0_dmask;
