...
_nmppsDivCRev_32f:
    ...
    ar0 = [--ar5]; // Divisor vector
    gr0 = [--ar5]; // Divided value
    ar1 = [--ar5]; // Output vector
	gr1 = [--ar5]; // Lenght
...
DivCRev_32f:
	...
	ar2 = ar7 + 2;// divided, divided
	ar3 = ar7 + 4; //Технологический массив на 64 слова
	ar4 = ar7 + 68; //Технологический массив на 64 слова
	ar7 = ar7 + 132;
...
*/
	...
	fpu 0 rep vlen vreg0 = [ar2]; //divided
	fpu 0 .float vreg7 = vreg0*vreg7;
