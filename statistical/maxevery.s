.globl _nmppsMaxEvery_16s_I
.globl _nmppsMaxEvery_32s_I
.globl _nmppsMaxEvery_32f_I
...
maxevery_less_32:
  gr1 = 1;
  gr0 - gr1;
  if =0 goto max_every_last_element;

  gr0 and gr1;
  if =0 goto exec_max_every_less_32;

  gr0 = gr0 - 1;

exec_max_every_less_32:
  gr1 = gr0 >> 1;
  gr1 = gr1 - 1;
  gr0 = gr0 - 1;
...
_nmppsMaxEvery_32f_I:
 ar5 = ar7 - 2;
  ...
  if =0 goto maxevery_less_32_32f;


maxevery_over_32_32f:
...
maxevery_less_32_32f:
  gr1 = 1;
  gr0 - gr1;
  if =0 goto max_every_last_element_32f;

exec_max_every_less_32_32f:
  gr1 = gr0 >> 1;
  gr1 = gr1 - 1;
